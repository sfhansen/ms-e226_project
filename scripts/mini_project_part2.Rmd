...
```{r}
model_labs <- c("Elastic Net", "Gradient Boosting Machine", "Random Forest")
model_breaks <- c("ELASTIC", "GBM", "RF")
...
Before fitting classification models, we perform recursive feature elimination
again to select the smallest set of features that achieve 5-fold cross-validated 
missclassification error within one standard error of the minimum. 
