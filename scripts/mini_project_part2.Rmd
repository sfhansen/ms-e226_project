...
varies in dollar amounts from \$MIN to \$MAX, whereas `number of bathrooms` 
ranges from 1 to 9. In turn, we center and scale the predictors in order to 
apply regularization techniques during the modeling phase. Further, we 
impute the few missing values of `median household income` with the column 
median.
```{r}
